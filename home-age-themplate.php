		...
		<div class="featured">
			...
			<ul class="clearfix">
				<li>
					<div class="frame1">
						<div class="box">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/meeting.jpg" alt="Img" height="130" width="197">
						</div>
					</div>
					<p>
				...
				<li>
					<div class="frame1">
						<div class="box">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/smile.jpg" alt="Img" height="130" width="197">
						</div>
					</div>
					<p>
				...
				<li>
					<div class="frame1">
						<div class="box">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/family-small.jpg" alt="Img" height="130" width="197">
						</div>
					</div>
					<p>
